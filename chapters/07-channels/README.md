...
Remember the `firstSuccess` combinator from [Chapter 05](../05-combinators/)? We solved the polling problem with something called `createSignal()`:
...
[Signals](../08-signals/) - bridging callbacks and external events into structured concurrency.
