...
We've learned all the core Effection concepts! In Part 4, we'll cover [Scope API](../11-scope-api/) for integrating Effection with external frameworks like Express.
