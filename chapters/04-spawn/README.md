...
Spawning tasks individually works, but there are patterns so common that Effection provides built-in combinators. Let's explore [all() and race()](../05-combinators/).
