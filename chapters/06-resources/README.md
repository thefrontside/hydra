...
Resources can produce values via `provide()`, but what about ongoing streams of data? In Part 3, we'll learn about [Channels](../07-channels/) for communication between operations.
